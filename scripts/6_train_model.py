...
def train_cytoself_model(datapath, outputpath, model_nm, data_ch):
    ...
    # Training completed! Analysis moved to separate script.
    print(f"Training completed successfully. Model saved at: {trainer.savepath_dict['model']}")
    print(f"To run analysis, use: python 3_analyze_model.py --datapath {datapath} --model_path {trainer.savepath_dict['model']} --model_nm {model_nm}")
    
    # Original analysis code (commented out - moved to 3_analyze_model.py):
