...
## CellPainting Gallery Paths for VarChAMP Project
...
## the relative path to store the images on your local machine
HOMEPATH="../../data/raw/varchamp_cellpainting_gallery" ## it is a symbolic link in this repo for storage of large datasets
# mkdir -p $HOMEPATH
