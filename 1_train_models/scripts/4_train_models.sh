...
python 2_train_model.py --datapath "../inputs/1_model_input/2025_07_B78-1112-1314-1516_clean" --outputpath "../outputs/trained_models" --model_nm "varchamp_080125_clean_data" > training_varchamp_080125_clean_data.log
